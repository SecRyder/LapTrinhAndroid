package com.ptithcm.broadcastreceiverdemo.activities;
...
import com.ptithcm.broadcastreceiverdemo.R;
import com.ptithcm.broadcastreceiverdemo.receivers.AirplaneModeReceiver;
import com.ptithcm.broadcastreceiverdemo.receivers.BatteryReceiver;
import com.ptithcm.broadcastreceiverdemo.receivers.CustomReceiver;
import com.ptithcm.broadcastreceiverdemo.receivers.NetworkChangeReceiver;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            registerReceiver(customReceiver, customFilter, Context.RECEIVER_NOT_EXPORTED); // <-- đổi từ EXPORTED sang NOT_EXPORTED
        } else {
